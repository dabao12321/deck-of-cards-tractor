...
var Deck = function () {
  ...
  var shuffle = {
    deck: function deck(_deck5) {
      _deck5.shuffle = _deck5.queued(shuffle);
  ...
  var sort = {
    deck: function deck(_deck6) {
      _deck6.sort = _deck6.queued(sort);
    ...
    card: function card(_card6) {
      var $el = _card6.$el;
      _card6.sort = function (i, len, cb, reverse) {
        var z = i / 4;
        var delay = i * 10;
        _card6.animateTo({
          delay: delay,
  ...
  var flip = {
    deck: function deck(_deck7) {
      _deck7.flip = _deck7.queued(flip);
      function flip(next, side) {
        var flipped = _deck7.cards.filter(function (card) {
          return card.side === 'front';
        }).length / _deck7.cards.length;
        _deck7.cards.forEach(function (card, i) {
  ...
  function Card(i) {
    ...
    self.animateTo = function (params) {
      var delay = params.delay,
        ...
        _params$x = params.x,
        x = _params$x === void 0 ? self.x : _params$x,
        _params$y = params.y,
        y = _params$y === void 0 ? self.y : _params$y,
        _params$rot = params.rot,
        rot = _params$rot === void 0 ? self.rot : _params$rot,
        ease$1 = params.ease,
